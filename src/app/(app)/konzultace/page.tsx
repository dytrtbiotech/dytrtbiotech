        ...
        {!doctor ? (
          ...
          <>
            ...
            {!booked ? (
              <>
                <section className="summary-block consult-doctor">
                  ...
                  <p className="flow-note consult-doctor-note">
                    Odkaz vede na externí systém ordinace. Termín si domluvíte
                    tam.
                  </p>
                </section>
              ...
              <>
                <section className="summary-block consult-doctor consult-doctor--booked">
                  <div className="doctor-card-head">
                    <h2>{doctor.name}</h2>
                    <span className="demo-badge">Demo</span>
                  </div>
                ...
                <section className="flow-card">
                  ...
                  {order?.consultationNote ? (
                    <p>{order.consultationNote}</p>
                  ) : null}
                  <p className="flow-note">
                    Zdroj: zadání uživatele v aplikaci.
                  </p>
